...
export const getVersionInfo = (): VersionInfo => {
  return {
    ...
    buildTime: process.env.MIGRATION_PLANNER_UI_BUILD_TIME || 'unknown',
  };
};

/**
 * Log version information to console for developers
 */
export const logVersionInfo = (): void => {
  const versionInfo = getVersionInfo();

  console.group('Migration Planner Version Information:');
  console.log('** ', versionInfo.ui.name, ':');
  console.log('    - Version Name:', versionInfo.ui.versionName);
  console.log('    - Git Commit:', versionInfo.ui.gitCommit);
  console.log('** ', versionInfo.api.name, ':');
  console.log('    - Version Name:', versionInfo.api.versionName);
  console.log('    - Git Commit:', versionInfo.api.gitCommit);
  console.log('** Build Time:', versionInfo.buildTime);
  console.log('** Access via:', 'window.__MIGRATION_PLANNER_VERSION__');
  console.groupEnd();
};
...
/**
 * Expose version information to window object for developer access
 */
